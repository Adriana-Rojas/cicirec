...
class StokePriceModel extends CI_Model {
	...
	public function insertStokePriceHeadHistory($idCotizacion,
		$fecha,
		$descuento,
		$idTipo,
		$pago ,
	...
	public function insertStokePriceLog($idCotizacion,
	...
	public function insertStokePriceTRM($idCotizacion,
