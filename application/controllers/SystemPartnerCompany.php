 ...
 public function __construct()
    {
        ...
        $this->load->model('EsaludModel'); // Libreria principal de las funciones referentes a la lectura de información del sistema ESALUD
    }
...
if ($this->FunctionsAdmin->validateSession ( $mainPage )) {
    		...
    		if ($this->encryption->decrypt($this->security->xss_clean($this->input->post('valida')))=='newRegister'){
    			...
    			$this->FunctionsGeneral->updateByID("ADM_ALIADA","EMPRESA", 
    					$empresa, $this->encryption->decrypt($this->security->xss_clean($this->input->post('id'))), $this->session->userdata('usuario'));
    			$this->FunctionsGeneral->updateByID("ADM_ALIADA","ID_MUNICIPIO",
    					$municipio, $this->encryption->decrypt($this->security->xss_clean($this->input->post('id'))), $this->session->userdata('usuario'));
