		...
		<div class="card">
			<div class="card-body p-b-0">
				...
				<ul class="nav nav-tabs customtab2" role="tablist">
					<li class="nav-item" style="<?=$hide?>"><a class="nav-link active" data-toggle="tab"
						href="#home" role="tab"><span class="hidden-sm-up"><i
								class="fa fa-home"></i></span> <span class="hidden-xs-down">Seguimiento</span></a>
					</li>
					<li class="nav-item"><a class="nav-link" data-toggle="tab"
						href="#history" role="tab"><span class="hidden-sm-up"><i
								class="fa fa-history"></i></span> <span class="hidden-xs-down">Hist&oacute;rico</span></a>
					</li>
					<li class="nav-item"><a class="nav-link" data-toggle="tab"
						href="#modify" role="tab"><span class="hidden-sm-up"><i
								class="fa fa-commenting-o"></i></span> <span class="hidden-xs-down">Historial de cambios</span></a>
					</li>

					<li class="nav-item"><a class="nav-link" data-toggle="tab"
						href="#documents" role="tab"><span class="hidden-sm-up"><i
								class="fa fa-folder-open"></i></span> <span class="hidden-xs-down">Documentos soporte</span></a>
					</li>
				...
				<div class="tab-content">
					<div class="tab-pane active" id="home" role="tabpanel" style="<?=$hide?>">
						...
						<form class=" form-horizontal" role="form"
							Action="<?= base_url()?>StokePriceAppStokePrice/saveTrace"
									...
									<div class="form-group ">
										...
										<div class="col-md-12">
											<textarea rows="5" class="form-control" cols=""
												...
												placeholder="Realice la justificaci&oacute;n de la observaci&oacute;n de seguimiento"></textarea>
											<div class="form-control-feedback"></div>
										</div>
									</div>
									...
									<div class="form-group adjunto" style="display: none;" >
                						...
                						<div class="col-md-12">
                							<input class="form-control " type="text" name="numero"
                								id="numero" placeholder="Ej. AUT-0894840-2018" />
                						</div>
                					</div>
									<div class="form-group adjunto" style="display: none;" >
										...
										<div class="col-md-12">
											<input type="file" class="form-control " id="adjunto"
												name="adjunto" disabled="disabled">
											<div class="form-control-feedback"></div>
										</div>
									</div>
            ...
            foreach ($listadoBitacora as $value) {
                ...
                ?>
									...
									<div class="media-body">
	                                                    ...
	                                                    <br><?= $value->NOMBRES." ".$value->APELLIDOS; ?> -
														<small><?= $value->PERFIL; ?></small><br /> <small> <i
											class="fa fa-clock-o"></i> <?= $value->FECHA; ?>
											<br>Costos adicionales: <?= "$ ".number_format($costoAdicional,2,",","."); ?>
											<br><?php if($descripcionCostos != null){ echo "Descripci&oacute;n de costos adicionales: ".$descripcionCostos; }else{echo "Descripci&oacute;n de costos adicionales: No realiz&oacute; descripciones";}?></small>
									</div></li>
	                                            <?php
            } // end foreach
        } // end if
