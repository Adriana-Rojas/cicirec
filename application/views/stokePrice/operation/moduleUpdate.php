...
<form class=" form-horizontal" role="form"
	action="<?= base_url()?>StokePriceAppStokePrice/editUser"
					...
					<div class="form-group">
						...
						<div class="col-md-5">
							<input class="form-control" type="text" name="documento"
								id="documento" placeholder="8888888888" />
						</div>
					</div>
				</div>
			</div>
...
if(isset($_POST['documento'])){
	...
	<?php	
		...
		$usuarioEsalud= 'sa';
	    $passEsalud = 'cirec2019..';
	    $servidorEsalud = 'SRVPRU\SQLEXPRESS';
	    $basedatosEsalud = 'esaludpruebas';
						...
						<div class="form-group">
							...
							<div class="col-md-12">
								<input class="form-control " type="text" name="nombre"
									id="documento" value = "<?php echo $NOMBRES;?>" disabled/>
									<input class="form-control " type="hidden" name="documento"
									id="documento" value = "<?php echo $documento;?>"/>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-12">
								<input class="form-control " type="text" name="apellido"
									id="nombres" value = "<?php echo $APELLIDOS;?>" disabled/>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-12">
								<input class="form-control" type="email" name="email"
									id="email" value = "<?php echo $CORREO;?>"/>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-12">
								<input class="form-control" type="text" name="movil"
									id="email" value = "<?php echo $telefonoMovil;?>"/>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-12">
								<input class="form-control" type="text" name="fijo"
									id="email" value = "<?php echo $telefonoFijo;?>"/>
							</div>
						</div>
						<!--<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-md-12">
									<input class="form-control" type="text" name="departamento"
										id="apellidos" value = "<?php echo $nombre_departamento_usuario;?>" disabled/>
								</div>
							</div>
	...
	<!-- este-->
						<div class="form-group">
							...
							<div class="col-md-12">
								<input class="form-control" type="text" name=""
									id="apellidos" value = "<?= utf8_encode($nombre_municipio)?>" disabled/>

									<input class="form-control" type="hidden" name="municipio"
									id="apellidos" value = "<?=$id_municipio?>" />
						...
						<div class="form-group ">
							...
							<div class="form-group">
								...
								<div class="col-md-12">
									<input class="form-control" type="text" name=""
										id="apellidos" value = "<?php echo $nombresApellidosEspecialista;?>" disabled/>
								</div>
							</div>
						</div>
							</div>
		...
		<div class="row">
			<div class="col-sm-12">
				<button type="submit" name = "Editar"
					class="btn btn-info btn-rounded waves-effect waves-light m-r-10 pull-right">Editar</button>
			</div>
			<div class="col-sm-12">
				<br>
			</div>
