						...
						<div class="card">
                            <div class="card-body">
	                           ...
	                           <div class="form-group " >
                                    ...
                                    <div class="col-md-12">
	                                    <input type="number" class="form-control" id="cantidad" name="cantidad" max="<?=$maximo ?>" min="1" 
	                                    value="<?php 
	                                    if ($elemento!=null){
	                                        echo $cantidad;
	                                    }else{
                                ...
                                <div class="form-group campo1">
										...
										<div class="col-md-12">
											...
											<select class="form-control " id="campo1"
												name="campo1" <?php if ($campo1==52 ){ ?> required="required"<?php  } ?> >
												<option value="">--- Seleccione una opci&oacute;n ---</option>
												<?= $valoresLista; ?>
											</select> 
											<?php 
											...
											<?php
			                               	...
			                               	?>
											<input type="text"
												class="form-control datepicker" id="campo1" name="campo1"  placeholder="aaaa/mm/dd" <?php if ($campo1==57 ){ ?> required="required"<?php  } ?>> 
                                ...
                                <div class="form-group campo2">
										...
										<div class="col-md-12">
											...
											<select class="form-control " id="campo2"
												name="campo2" <?php if ($campo2==52 ){ ?> required="required"<?php  } ?> >
												<option value="">--- Seleccione una opci&oacute;n ---</option>
												<?= $valoresLista; ?>
											</select> 
											<?php 
											...
											<?php
			                               	...
			                               	?>
											<input type="text"
												class="form-control datepicker" id="campo2" name="campo2"  placeholder="aaaa/mm/dd" <?php if ($campo2==57 ){ ?> required="required"<?php  } ?>> 
                                ...
                                <div class="form-group campo3">
										...
										<div class="col-md-12">
											<?php
			                               	...
			                               	?>
											<select class="form-control " id="campo3"
												name="campo3" <?php if ($campo3==52 ){ ?> required="required"<?php  } ?> >
												<option value="">--- Seleccione una opci&oacute;n ---</option>
												<?= $valoresLista; ?>
											</select> 
											<?php 
											...
											<?php
			                               	...
			                               	?>
											<input type="text"
												class="form-control datepicker" id="campo3" name="campo3"  placeholder="aaaa/mm/dd" <?php if ($campo3==57 ){ ?> required="required"<?php  } ?>> 
                                ...
                                <div class="form-group campo4">
										...
										<div class="col-md-12">
											...
											<select class="form-control " id="campo4"
												name="campo4" <?php if ($campo4==52 ){ ?> required="required"<?php  } ?> >
												<option value="">--- Seleccione una opci&oacute;n ---</option>
												<?= $valoresLista; ?>
											</select> 
											<?php 
											...
											<?php
			                               	...
			                               	?>
											<input type="text"
												class="form-control datepicker" id="campo4" name="campo4"  placeholder="aaaa/mm/dd" <?php if ($campo4==57 ){ ?> required="required"<?php  } ?>> 
                                ...
                                <div class="form-group campo5">
										...
										<div class="col-md-12">
											...
											<select class="form-control " id="campo5"
												name="campo5" <?php if ($campo5==52 ){ ?> required="required"<?php  } ?> >
												<option value="">--- Seleccione una opci&oacute;n ---</option>
												<?= $valoresLista; ?>
											</select> 
											<?php 
											...
											<?php
			                               	...
			                               	?>
											<input type="text"
												class="form-control datepicker" id="campo5" name="campo5"  placeholder="aaaa/mm/dd" <?php if ($campo5==57 ){ ?> required="required"<?php  } ?>> 
